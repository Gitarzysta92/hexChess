...
import { Component, OnInit, OnChanges, OnDestroy, ViewChild, TemplateRef, Input, Output, ChangeDetectorRef, Optional, Self, Inject, ViewContainerRef, ElementRef, SimpleChanges, EventEmitter } from "@angular/core";
...
export class NicknameInputComponent implements OnInit, OnChanges, OnDestroy  {
  ...
  constructor(
    ...
    const asd = new BehaviorSubject(null);

    asd.pipe(takeUntil(this._onDestroy)).subscribe()
