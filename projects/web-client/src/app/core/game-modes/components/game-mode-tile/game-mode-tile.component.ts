...
import { GameModesService } from '../../services/game-modes/game-modes.service';
...
export class GameModeTileComponent implements OnInit, OnDestroy {
  ...
  public startMatchmaking(): void {
    this._routingService.navigateToMatchmaking(this._mode.configuration.gameMode, this._mode.configuration.playersNumber)
  }
