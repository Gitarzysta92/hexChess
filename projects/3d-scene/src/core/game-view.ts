...
export class GameView {
  ...
  public getObjectAt<T extends Instantionable>(worldCoords: THREE.Vector3, asd: any): T | null;
  public getObjectAt<T extends Instantionable>(screenCoors: THREE.Vector2): T | null;
  public getObjectAt<T extends Instantionable>(coords: THREE.Vector2 | THREE.Vector3): T | null {
