...
export class MatchmakingService {
  ...
  public async findQuickmatch( profileId: string, requiredPlayers: number, selectedArmies: string[] ): Promise<MatchmakingResult> {
    ...
    this._matchmakingQueue.playerTimedOut$
      .subscribe(result => {
        this._eventService.emit(new PlayerLeftMatchmakingRoomEvent({
          playerLeftId: result.timedPlayer.profileId,
