...
import { BlobStorageConfig, ConnectionString } from 'src/infrastructure/blob-storage-client/blob-storage.config';
...
import { BlobStorageAsyncConfig } from './blob-storage.interfaces';
